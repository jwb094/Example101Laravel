<!doctype html>
<html class="no-js h-full bg-gray-100" lang="">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <x-navi-link href="/" type="a" :active="request()->is('/')">Home</x-navi-link>
                                <x-navi-link href="/jobs" type="a" :active="request()->is('jobs')">Jobs</x-navi-link>
                                <x-navi-link href="/contact" type="a" :active="request()->is('contact')">Contact</x-navi-link>
                            </div>
                        </div>
                    </div> 
                    <div class="hidden md:block">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm font-medium leading-none text-gray-400">larryRobot@example.com</div>
                        </div>
                        <button type="button"
